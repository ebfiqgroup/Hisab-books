...
import {
  ...
  ShieldCheck, Sparkles, BarChart3, Receipt, ListChecks, Flame, Calendar, Zap, Trophy, AlertTriangle, Scale,
} from "lucide-react";
...
function Dashboard() {
  ...
  const statCards = [
    ...
    { label: t("অবশিষ্ট", "Remaining"), value: fmtTk(curSav), last: fmtTk(prevSav), pct: pctChange(curSav, prevSav), Icon: Scale, grad: "from-blue-500 to-indigo-500", ring: "ring-blue-100", val: "text-blue-600", to: "/budget" as const },
  ...
  return (
    <AppShell title={t("ড্যাশবোর্ড", "Dashboard")}>
      ...
      <div className="text-center text-xs text-slate-500 mt-6">© {toBn(now.getFullYear())} {t("হিসাব বই", "My Finance")} <span className="text-rose-500">♥</span></div>
